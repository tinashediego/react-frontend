...
function kitsData(number, date, brandName,batchNumber,serialNumber) {

  return {number, date, brandName,batchNumber,serialNumber};
}

const rows = [
  kitsData(1, '03-01-1995','Munya', 78322333,'344434k43'),
